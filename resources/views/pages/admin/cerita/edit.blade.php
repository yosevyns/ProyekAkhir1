                  ...
                  <div class="col-md-10 col-12">
                    <div class="card">
                      <div class="card-header">
                        <h4 class="card-title">Form Edit Cerita Ulos</h4>
                      </div>
                      <div class="card-body">
                        <form action="{{route('sejarah.update', $ceritum->id)}}" method="post" enctype="multipart/form-data">
                            @method('PUT')  
                          @csrf
                            <div class="row">
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea id="summernote" name="deskripsi_ulos" >{!! $ceritum->deskripsi_ulos !!}</textarea>
